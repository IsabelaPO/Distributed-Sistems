...
public final class TTTGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pt.tecnico.ttt.playRequest,
      pt.tecnico.ttt.playResponce> getPlayMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Play",
      requestType = pt.tecnico.ttt.playRequest.class,
      responseType = pt.tecnico.ttt.playResponce.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.tecnico.ttt.playRequest,
      pt.tecnico.ttt.playResponce> getPlayMethod() {
    io.grpc.MethodDescriptor<pt.tecnico.ttt.playRequest, pt.tecnico.ttt.playResponce> getPlayMethod;
    if ((getPlayMethod = TTTGrpc.getPlayMethod) == null) {
      synchronized (TTTGrpc.class) {
        if ((getPlayMethod = TTTGrpc.getPlayMethod) == null) {
          TTTGrpc.getPlayMethod = getPlayMethod =
              io.grpc.MethodDescriptor.<pt.tecnico.ttt.playRequest, pt.tecnico.ttt.playResponce>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.playResponce.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<pt.tecnico.ttt.checkWinnerRequest,
      pt.tecnico.ttt.checkWinnerResponce> getCheckWinnerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckWinner",
      requestType = pt.tecnico.ttt.checkWinnerRequest.class,
      responseType = pt.tecnico.ttt.checkWinnerResponce.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.tecnico.ttt.checkWinnerRequest,
      pt.tecnico.ttt.checkWinnerResponce> getCheckWinnerMethod() {
    io.grpc.MethodDescriptor<pt.tecnico.ttt.checkWinnerRequest, pt.tecnico.ttt.checkWinnerResponce> getCheckWinnerMethod;
    if ((getCheckWinnerMethod = TTTGrpc.getCheckWinnerMethod) == null) {
      synchronized (TTTGrpc.class) {
        if ((getCheckWinnerMethod = TTTGrpc.getCheckWinnerMethod) == null) {
          TTTGrpc.getCheckWinnerMethod = getCheckWinnerMethod =
              io.grpc.MethodDescriptor.<pt.tecnico.ttt.checkWinnerRequest, pt.tecnico.ttt.checkWinnerResponce>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.checkWinnerResponce.getDefaultInstance()))
  ...
  public static abstract class TTTImplBase implements io.grpc.BindableService {
    ...
    public void play(pt.tecnico.ttt.playRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.playResponce> responseObserver) {
    ...
    public void checkWinner(pt.tecnico.ttt.checkWinnerRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.checkWinnerResponce> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                pt.tecnico.ttt.checkWinnerResponce>(
  ...
  public static final class TTTBlockingStub extends io.grpc.stub.AbstractBlockingStub<TTTBlockingStub> {
    ...
    /**
     */
    public pt.tecnico.ttt.playResponce play(pt.tecnico.ttt.playRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public pt.tecnico.ttt.checkWinnerResponce checkWinner(pt.tecnico.ttt.checkWinnerRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TTTFutureStub extends io.grpc.stub.AbstractFutureStub<TTTFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.tecnico.ttt.playResponce> play(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.tecnico.ttt.checkWinnerResponce> checkWinner(
