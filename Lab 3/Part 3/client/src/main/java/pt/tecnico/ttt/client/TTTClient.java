		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			do {
				...
				do {
					...
					play_res = stub.play(playRequest.newBuilder().setPlayer(player).setRow(row).setColumn(column).build()).getResult();
				...
				winner = stub.checkWinner(checkWinnerRequest.getDefaultInstance()).getPlayer();
